...
public class StringOperations {
	...
	public static boolean isSameFirstStringPosition(String string1, String string2, String str) {
        ...
        for(int i = 0; i < string1.length() - j  ; i++ ) {

        	if (string1.substring(i,j).equals(str) ||  string2.substring(i,j).equals(str)) {
        	          return string1.substring(i,j).equals(string2.substring(i, i));
        	}
          }
    	}
    return false; 
	...
	public static boolean isLess(String string1, String string2) {
	 ...
	 public static String getCommonPrefix(String string1, String string2) {
		 ...
		 char probel = ' ';
         for(int i = 0; i < string1.length()-1; i++) {
        	 if(string1.charAt(i) == ' ') break;
        	 temp1 = temp1 + string1.charAt(i);

         }
         for(int i = 0; i < string2.length()-1; i++) {
        	 if(string2.charAt(i) == ' ') break;
        	 temp2 = temp2 + string2.charAt(i);
         }
